...
> Install the [Text Plates](https://mods.factorio.com/mod/textplates) mod if needed.
...
- The negative mask from the indexer: `{ rail: -1M, inserter: -1M }` when `chest` is selected.
...
The brainwave for this came after I read a [Reddit comment](https://www.reddit.com/r/factorio/comments/gp1idk/the_evolution_of_my_vanilla_logistic_train/frnfajy/?context=3) on the first post. I can use a filter inserter to select and isolate a single item from a mixed-item signal.
